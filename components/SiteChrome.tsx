    ...
    <header className="site-header">
      <div className="container nav">
        ...
        <nav aria-label="Primary">
          ...
          <Link className="nav-cta" href="/contribute/">Contribute</Link>
    ...
    <footer>
      <div className="container footer-grid genome-footer">
        <div>
          ...
          <p>The public home where people can encounter The Way, explore the Dang Genome, develop Your Way, and contribute to The Way Forward.</p>
        ...
        <div>
          ...
          <Link href="/share/">Submit a Contribution</Link>
