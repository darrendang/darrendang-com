...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section className="section navy"><div className="container book-grid"><div className="book-art" aria-label="For Those Who Come After Us book cover"><span className="cover-star">✦</span><div className="cover-title">FOR THOSE<br/>WHO COME<br/>AFTER US</div><div className="cover-rule"/><div className="cover-sub">A LIFE IN LESSONS</div><svg viewBox="0 0 300 250" role="presentation"><defs><linearGradient id="g" x1="0" y1="1" x2="0" y2="0"><stop offset="0" stopColor="#705A3D"/><stop offset="1" stopColor="#E8B85C"/></linearGradient></defs><path d="M145 248 C95 205 220 180 155 145 C95 113 190 90 151 55 C130 35 150 18 150 0" fill="none" stroke="url(#g)" strokeWidth="12" strokeLinecap="round"/><circle cx="150" cy="8" r="7" fill="#F4CF80"/></svg><div className="cover-author">DARREN DANG</div></div><div><div className="eyebrow">The first major artifact</div><h2>For Those Who Come After Us</h2><p className="book-sub">A Life in Lessons</p><p>No one can leave the next generation an answer for every situation. The next best thing is to leave behind some of the thinking that helped us find our way.</p><p>The book moves through six stages:</p><div className="progression">INHERIT → BECOME → CONNECT → LEAD → LIVE → PASS FORWARD</div><p>It is where many of the ideas on this site first took shape.</p><Link className="button button-light" href="/books/for-those-who-come-after-us/">Explore the Book</Link></div></div></section>

      <section className="section ivory"><div className="container about-grid"><div className="portrait-placeholder"><div className="portrait-initials">DD</div><small>Portrait placeholder for approved Darren headshot</small></div><div><div className="eyebrow bronze">The person behind the ideas</div><h2>A life between worlds.</h2><div className="pairs">Vietnam and America.<br/>Computer science and business.<br/>Technology and public institutions.<br/>Analysis and judgment.<br/>Leadership and family.<br/>One generation and the next.</div><p className="question">What is worth keeping—and what needs to change?</p><p>I have learned from parents, teachers, colleagues, failures, institutions, and my own children. The point was never to collect lessons. It was to understand which ones were useful enough to put to work.</p><Link className="text-link" href="/about/">About Darren →</Link></div></div></section>
