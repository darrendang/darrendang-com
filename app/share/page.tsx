...
export const metadata = {
  title: 'Submit for Private Review',
  description: 'Submit a story, lesson, question, correction, reflection, or short video for private editorial review as something that may be worth passing forward.'
};
...
export default function ShareWisdomPage(){
  ...
  return <InteriorPage eyebrow="Pass It Forward · Private Intake" title="What have you learned that you would want someone who comes after you to know?" wide>
    <div className="share-intro-grid">
      <div>
        <p className="lead">You can share a reflection, story, lesson, question, correction, alternate perspective, new connection, or brief video. This form gives permission for private review only. Nothing is published automatically.</p>
        <p>If a submission is selected, DarrenDang.com may edit it for clarity or length and send the proposed public version back to you. Publication requires your separate approval of that version.</p>
      </div>
      <aside className="intake-flow" aria-label="Contribution review process">
        <span>Submit</span><b>→</b><span>Private Review</span><b>→</b><span>Select</span><b>→</b><span>Edit</span><b>→</b><span>Your Approval</span><b>→</b><span>Publish</span>
      </aside>
    </div>
    ...
    <section className="share-form-section" aria-labelledby="share-form-title">
      ...
      <div className="intake-status intake-status-live" role="status"><strong>Secure private intake is active.</strong><p>Your submission and any attachment are sent to a private review queue. They are not committed to the public website repository and are not published automatically.</p></div>
      <form className="wisdom-form" action={endpoint} method="post" encType="multipart/form-data">
        ...
        <div className="form-row two-col">
          ...
          <label>If later published, how would you prefer to be credited?
        ...
        <fieldset className="permission-fieldset">
          <legend>Permission for private review</legend>
          <label className="check-label"><input name="rights_confirmed" type="checkbox" required />I created this contribution or have permission to share it and any attached media for private review.</label>
          ...
          <label className="check-label"><input name="publication_process_acknowledged" type="checkbox" required />I understand that this submission is not permission to publish. If selected, I will be asked to approve the proposed public version separately before publication.</label>
        </fieldset>
        <div className="form-submit-row">
          <button className="button button-dark" type="submit">Submit for private review</button>
    ...
    <section className="contribution-policy">
      ...
      <div className="policy-grid">
        <article><h3>Nothing publishes automatically.</h3><p>Every contribution is reviewed before it can even be considered for public use.</p></article>
        <article><h3>Publication requires a second yes.</h3><p>If selected, the exact proposed public version returns to the contributor for explicit approval.</p></article>
